...
class CategoryScreenBodyWidget extends StatelessWidget {
  const CategoryScreenBodyWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(), // Important for SliverList context
